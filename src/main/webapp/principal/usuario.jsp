											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														...
														<form class="form-material" action="<%= request.getContextPath()%>/ServletUsuarioController1" method="post" id="formUser">
														...
														<input type="hidden" name="acao" id="acao" value="">
															...
															<button type="button" class="btn btn-danger waves-effect waves-light" onclick="criarDeletComAjax();">Excluir</button>
